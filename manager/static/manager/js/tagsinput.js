 ...
 * 
 */
console.log('bootstrap-tagsinput v0.8.0');
(function ($) {
  "use strict";
  ...
  function TagsInput(element, options) {
    ...
    // list
    this.list = element.hasAttribute('list') ? this.$element.attr('list') : '';

    this.$container = $('<div class="bootstrap-tagsinput"></div>');
    this.$input = $('<input type="' + this.type + '" name="' + this.name + '" placeholder="' + this.placeholderText + '"list="' + this.list + '"/>').appendTo(this.$container);
